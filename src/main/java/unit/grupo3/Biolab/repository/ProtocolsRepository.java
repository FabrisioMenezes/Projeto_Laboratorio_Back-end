...
public interface ProtocolsRepository extends JpaRepository<ProtocolsEntity, Long> {
    ...
    List<ProtocolsEntity> getByFirstResearcherMatriculation(Integer matriculation);
    List<ProtocolsEntity> getBySecondResearcherMatriculation(Integer matriculation);
    List<ProtocolsEntity> getByThirdResearcherMatriculation(Integer matriculation);
}
